...
- 接着参考`tickets`目录中的[示例文件](tickets/ticket-demo.md)的格式，新建一个`“你的”-D2邀请函申请.md`(例如:"晓白-D2邀请函申请.md")为名称的文件，
- 再仿照例子填写相关资料，
...
- 注^[1]: 登记入场信息的[示例说明](tickets/info-submit-demo.md)。
...
- 或许你可以在`tickets`目录中的[ticket-bad-case.md](tickets/ticket-bad-case.md)文件中找到原因。
